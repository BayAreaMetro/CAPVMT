-- =============================================
-- Author:		Lisa Zorn - Edited by sfoo - updated for 2017 plan data by tbdv
...
BEGIN
	...
	END
	ELSE IF @modelrun = '2030_06_694'
	BEGIN
	  SELECT @persons_table = '[CAPVMT].[persons_2030_06_694]';
	  SELECT @vmt_table = '[CAPVMT].[vmt_2030_06_694]';
	END
	ELSE IF @modelrun = '2040_06_694'
	BEGIN
	  SELECT @persons_table = '[CAPVMT].[persons_2040_06_694]';
	  SELECT @vmt_table = '[CAPVMT].[vmt_2040_06_694]';
	END
	ELSE
	BEGIN
